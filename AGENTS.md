...
- **اقرأ أيضاً `IDENTITY.md`** إلى جانب `PROJECT_STATUS.md` في بداية أي محادثة جديدة — هو المرجع الإلزامي الوحيد لأي نص يصف صاحب الموقع (الاسم، المسمى، جملة الهوية، الوصف المختصر، مجالات النشاط، المصطلحات، العبارات المحظورة، العضويات). أي تعديل على نص عام يصف صاحب الموقع في أي صفحة أو ملف بيانات يجب أن يلتزم به حرفياً، دون اختراع رقم أو تاريخ أو جهة غير موجودة فيه أو في ملفات `data/`.
...
- عند الحاجة الفعلية لفصل بصري بين معلومتين متجاورتين داخل نص واحد (مثل اسم برنامج يتلوه اسم جهة)، تُستخدم العلامة "|" بمسافة قبلها وبعدها، بدلاً من الشرطة.
- استثناء صريح: الشرطة القصيرة "–" داخل مدى أرقام أو سنوات (مثل 2026–2027) غير مشمولة بهذا المنع، لأنها ترميز قياسي للمدى لا أداة فصل.
